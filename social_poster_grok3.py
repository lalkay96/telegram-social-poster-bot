...
async def start(update, context):
    ...
    welcome_message = (
        "Welcome to @CashflowSocialPoster!\n"
        "Use /post <message> to share text, images, or videos to @the9jacashflow, Twitter, Instagram, and Facebook.\n"
        "Use /privacy to view data usage information."
    )
    await update.message.reply_text(welcome_message)

async def privacy(update, context):
    """Handle /privacy command and show privacy policy."""
    privacy_message = (
        "Your messages, images, and videos are posted publicly to @the9jacashflow, Twitter, Instagram (9jacashflow), and Facebook.\n"
        "No user data is stored. To opt out, block the bot or contact us."
    )
